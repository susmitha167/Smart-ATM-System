...
?>
<script language="javascript">
window.location.href="ck.php?id=<?php echo $id; ?>&act=reject";
</script>
<?php
}
?>
		...
		<div class="row align-items-center">
			...
			<div class="col-md-6 text-center order-1 order-md-2">
					...
					<div class="st3 content text-center">
						...
						<div class="title-text">
						<img src="upload/img<?php echo $id; ?>.png" />
						</div>
						...
						?>
						<input class="form-control main" type="text" name="amount" placeholder="Enter Amount" maxlength="4" required>
